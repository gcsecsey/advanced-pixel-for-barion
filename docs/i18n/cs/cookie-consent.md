...
3. Pokud marketingový souhlas není udělen, neudělá nic — `rejectConsent` se při načtení stránky neodesílá; odešle se až poté, co návštěvník odpoví v cookie liště (viz bod 4)
