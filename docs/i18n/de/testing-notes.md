...
3. `unitPrice` ist der echte Preis, nicht `0`. Der Button trägt keinen Preis, dieser kommt also aus der Store-API; eine `0` bedeutet, dass diese Anfrage fehlgeschlagen ist.
